...
README ini berisi penjelasan mengenai program.

Program dibuat dengan menggunakan Python. 

Penting: Jika Windows Defender Firewall mendeteksi file EXE sebagai virus ketika dirun, tolong klik tombol More Info, kemudian klik tombol Run Anyway. Itu hanya bentuk antisipasi dari sistem windows saja. Tidak ada virus di aplikasi exe ini.
